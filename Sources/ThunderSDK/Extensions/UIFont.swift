...
extension UIFont {
    ...
    static let SP1: UIFontDescriptor = SPFontType.Splatfont1.descriptor

    static let SP2: UIFontDescriptor = SPFontType.Splatfont2.descriptor

    convenience init(_ type: SPFontType, size: CGFloat) {
        switch type {
        case .Splatfont1:
