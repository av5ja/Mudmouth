...
//                let enemyId: CoopEnemy = CoopEnemy.allCases[index]
...
//        })
    ...
    @ViewBuilder
    private func _body(_ enemyId: CoopEnemy, bossCount _: CGFloat, bossKillCount _: CGFloat, count _: Int, bias: CGFloat) -> some View {
